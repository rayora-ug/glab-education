...
// A repeat sitting of an existing question bank reuses the same content,
// just under a new exam code — keeps one canonical question bank per level
// instead of duplicating 100+ questions per sitting.
...
export const EXAM_REGISTRY: Record<string, ExamData> = {
  ...
  [examB1_0731.examCode]: examB1_0731,
}
