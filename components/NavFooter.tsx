...
import {
  ...
  Facebook, MessageCircle, Mail, MapPin,
        ...
        <nav className="flex items-center justify-between h-16 md:h-18">
          <Link href="/" className="flex items-center gap-3 group" onClick={() => setOpen(false)}>
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="font-mono hidden sm:block" style={{color:'var(--text-muted)',fontSize:'9px',letterSpacing:'0.1em',marginTop:'2px'}}>GERMAN LANGUAGE ACADEMY</span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/vocab-test" className="hidden md:flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all border"
      ...
      {open && (
        <div className="lg:hidden glass border-t" style={{borderColor:'var(--border)'}}>
          <div className="container py-4 flex flex-col gap-1">
            ...
            <Link href="/registration" onClick={() => setOpen(false)} className="btn-primary mt-2 text-sm justify-center">
              Register Now <ArrowRight size={14} />
            </Link>
          </div>
        </div>
