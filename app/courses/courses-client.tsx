            ...
            {filtered.map((c: any) => (
              <div key={c.id} className="card flex flex-col relative overflow-hidden">
                ...
                <div className="p-6 flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-5 p-4 rounded-xl text-xs" style={{background:'var(--bg-secondary)',color:'var(--text-muted)'}}>
      ...
      <section className="section" style={{background:'var(--bg-secondary)'}}>
        <div className="container">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-0">
            {['A1', 'A2', 'B1', 'Germany'].map((level, i, arr) => (
