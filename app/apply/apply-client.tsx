      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="card p-8 flex flex-col">
            ...
            <p className="text-sm mb-6 flex-1" style={{ color: 'var(--text-muted)' }}>
              Already have a GLAB ID? Log in to MyGLAB to choose your batch and complete your registration.
            </p>
            <div className="flex flex-col gap-3">
              <Link href="/myglab" className="btn-primary w-full justify-center">
                <LogIn size={16} /> Go to MyGLAB
              </Link>
            </div>
          </div>
        </div>
