...
const ALLOWED_PREFIXES = ['/portal', '/api/portal', '/results', '/api/results', '/exam', '/exam-grammar', '/exam-b1', '/pruefung', '/api/exam', '/books', '/_next', '/favicon.ico', '/manifest.json', '/robots.txt', '/sitemap.xml']
